        ...
        if(connection == null){
            try{
                ...
                System.out.println("\n\n  Koneksi ke Database berhasil.... IP komputer: "+inetAddress.getHostAddress()+ "\n\n" +
                        ...
                        "  1) Form/Java: RMPenilaianAwalKeperawatanRalan.java, SuratButaWarna.java 1, SuratBebasNarkoba.java 1, DlgIKBBayi.java 1, SuratKeteranganSehat.java 0, DlgPasienMati.java 0, SuratSakit.java0, DlgCariPeriksaLab.java, DlgPermintaanLaboratorium.java, koneksiDB.java, sekuel.java;    \n"+
                        "   ) Form/Java: DlgCopyResep.java; DlgRawatJalan.java    \n"+
                        ...
                        "   ) Report: rptPeriksaLabPADTHJ.jasper dr. Frau, rptPeriksaLabPADTHJ2.jasper dr. Frau;      \n"+
                        "  3) Perbaikan: Permintaan Lab., Hasil Periksa Lab. PA., Perbesar limit iputan Lab. PA dan varchar pada tabel database detail_periksa_labpa menjadi text agar deskripsi bisa panjang;     \n"+
                        "  4) Tambahan: Lengkapi SOAP dokter Rajal, Tambah Menu pada Periksa Lab. PA dan Cetak mode 1-2 MDT / Morfologi Darah Tepi; Disable Edit dan Hapus pada Obat Terlayani;     \n"+
                        "  Re-Compile_By: Bang Riyan Hidayat Samosir - www.HanyaJasa.Com - hanyajasa@gmail.com, 08.07 20/07/2024 - RS Islam PKU Muhammadiyah Palangka Raya.");
            }catch(Exception e){
